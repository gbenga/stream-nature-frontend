...
class LocationShowPage extends Component {
  ...
  render() {
    ...
    return (
      ...
      <h5> This is {this.props.location.city}, {this.props.location.country} show Page </h5>
        <img className="location-img" src={this.props.avatar} alt=""/>
        <p> {this.props.location.bio} </p>
